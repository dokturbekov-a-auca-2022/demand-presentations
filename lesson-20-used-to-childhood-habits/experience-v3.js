...
(() => {
  const config = {"dir":"lesson-20-used-to-childhood-habits","mode":"capsule","label":"TIME CAPSULE","colors":["#52cbbb","#f8dc83","#41243f","#fff7e5"],"labScene":21,"lab":{"title":"Object across time","prompt":"Hold up a real object or choose a fictional one. Tell its then-story and now-routine while partners build a two-frame time capsule.","roles":["Storyteller: explain the old habit.","Now reporter: explain what feels normal today.","Illustrator: draw the two frames.","Language detective: label used to and be used to."],"rounds":["30 sec · object reveal","3 min · then/now interview","45 sec · capsule tour"],"success":"The two meanings stay separate and the picture makes the time contrast immediately clear."},"taskScenes":[2,4,7,9,10,11,13,15,16,18,19,20,21,22,24,27],"audio":[{"scene":15,"file":"then-now-story.wav","label":"STORY TRACK · SORT THEN / NOW","text":"When Talia was younger, she used to live above a busy bakery. She did not use to wake up late because the bakers started early. Now she lives in a quiet house, and she is used to hearing birds in the morning."},{"scene":9,"file":"used-to-contrast.wav","label":"MEANING CONTRAST · OLD vs NORMAL","text":"I used to walk to school. That was my old habit. I am used to taking the bus now. That means the new routine feels normal."},{"scene":21,"file":"memory-interview.wav","label":"INTERVIEW MODEL · BORROW A QUESTION","text":"What game did you use to play? I used to play hide and seek after school. Are you used to playing online games now? Yes, but I still enjoy outdoor games."}]};
