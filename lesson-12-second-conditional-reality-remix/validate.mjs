...
check('26 scenes',scenes.length===26,scenes.length);
...
check('teacher note on every scene',(source.match(/<aside class="teacher">/g)||[]).length===26,(source.match(/<aside class="teacher">/g)||[]).length);
...
check('listening and production stages',['linaPlay','lina-town-pitch.wav','productionTimer','Review quiz'].every(token=>source.includes(token)),'complete');
