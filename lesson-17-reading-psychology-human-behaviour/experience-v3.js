...
(() => {
  const config = {"dir":"lesson-17-reading-psychology-human-behaviour","mode":"evidence","label":"FIELD LENS","colors":["#d6a84e","#718b55","#172d3b","#fffaf0"],"labScene":21,"lab":{"title":"Evidence lens","prompt":"Annotate one behaviour mystery together. Separate what the text proves from what your mind adds, then test a second explanation.","roles":["Observer: quote one visible fact.","Interpreter: suggest what it might mean.","Skeptic: propose another explanation.","Researcher: write the next useful question."],"rounds":["Green · observation","Amber · inference","Blue · open question"],"success":"Every interpretation points to textual evidence and the group keeps uncertainty visible."},"taskScenes":[2,3,5,8,10,13,16,18,20,21,23,25,27],"audio":[{"scene":16,"file":"red-umbrella.wav","label":"READING TRACK A · ATTENTION","text":"On the way to the cafe, Lina decided to count red things. She noticed a red umbrella, a red bicycle, and a red cup. At the door, her friend Sam waved, but Lina did not see him. Her attention had been tuned to one colour."},{"scene":18,"file":"remembered-route.wav","label":"READING TRACK B · MEMORY","text":"Noor remembered turning left at a fountain and then crossing a bridge. She felt completely sure. But the map showed no fountain. Her memory had kept the bridge and mixed the blue sign with another walk."},{"scene":21,"file":"evidence-model.wav","label":"THINK-ALOUD · LABEL EACH MOVE","text":"Observation: Lina counted red objects. Inference: she may have missed Sam because her attention was focused. Question: what other explanation could fit the evidence?"}]};
