...
(() => {
  const config = {"dir":"lesson-21-business-english-basics","mode":"office","label":"MEETING PULSE","colors":["#b9eadc","#ef7654","#17334a","#fff8e8"],"labScene":21,"lab":{"title":"Eight-minute rescue meeting","prompt":"A launch is late and the customer needs an update. Run a timed online meeting that ends with one owner, one deadline, and one polite message.","roles":["Facilitator: open, sequence, and close.","Project lead: explain the problem briefly.","Client voice: ask for one clear outcome.","Scribe: share the final action line in chat."],"rounds":["2 min · facts, no solutions","3 min · options and polite challenge","3 min · decision, owner, deadline"],"success":"The meeting produces an action, an owner, a deadline, and respectful business language."},"taskScenes":[2,4,6,7,8,10,11,14,16,17,18,19,20,21,22,25,28],"audio":[{"scene":16,"file":"phone-call.wav","label":"PHONE MODEL · CATCH THE PURPOSE","text":"Good morning, Bright Ideas. This is Lina speaking. How can I help? Hello, I am calling about the project deadline. Could you confirm the date? Yes. The final file is due on Friday at three."},{"scene":18,"file":"mini-meeting.wav","label":"MEETING MODEL · ACTION + OWNER","text":"Could we start? First, let us share updates. The design is ready, but the budget needs checking. I agree. Could we decide who will contact the customer? I will do it and send an update by tomorrow."},{"scene":10,"file":"polite-email.wav","label":"EMAIL MODEL · NOTICE THE REQUEST","text":"Subject: Updated project plan. Hello Ms Khan. Please find the revised plan attached. Could you check the new deadline and let me know if Friday works for you? Best wishes, Alex."}]};
